...
class Maze(Dictionary<Coordinate, char> Maze){
    ...
    private List<(Position Position, int Cost, List<Coordinate> CurrentPath)> GetPositionsAndPrice(Position CurrentPosition, int CurrentPrice, List<Coordinate> CurrentPath){
