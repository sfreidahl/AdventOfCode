...
Console.BufferHeight = Math.Max(150, Console.BufferHeight);
Console.BufferWidth = Math.Max(150, Console.BufferWidth);
...
Console.WriteLine(nodes.Where(x => x.VisitedFrom.Count > 0).Count());
